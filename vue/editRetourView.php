    ...
    <section>
      <?php if ($messageInscription) : { ?>
        <div class="alert alert-success text-center" role="alert">
          Vous avez ajouté un retour avec succès.
        </div>
      <?php }
      endif ?>

      <h2 class="mb-3">Nouveau Retour</h2>2
    </section>
    ...
    <form name="add" action="editRetour.php?op=a" method="GET">
      <div class="container my-5  justify-content-center align-items-center">
        ...
        <section class="mb-3">
          ...
          <div class="col-md-6">
            <select class="form-select" aria-label="Default select example" name="id_ens" id="id_ens"
              value="<?= htmlentities($valeurs['id_ens'] ?? '') ?>">
        ...
        <section class="mb-3">
          ...
          <div class="col-md-6">
            <select class="form-select" aria-label="Default select example" name="select_id_statut" id="select_id_statut"
              value="<?= htmlentities($valeurs['select_id_statut'] ?? '') ?>">
        ...
        <section class="mb-3">
          ...
          <div class="col-md-6">
            <input id="date_achat" name="date_achat" type="date" class="form-control" size="30" maxlength="30"
        ...
        <section class="mb-3">
          ...
          <div class="col-md-6">
            <input id="date_envoi" name="date_envoi" type="date" class="form-control" size="30" maxlength="30"
              value="<?php echo date("Y-m-d"); ?>" />
            <br />
        ...
        <section class="mb-3">
          ...
          <div class="col-md-6">
            <input id="date_remboursement" name="date_remboursement" type="date" class="form-control" size="30"
              maxlength="30" value="<?php echo date("Y-m-d"); ?>" />
            <br />
        ...
        <section class="mb-3">
          <div class="col-md-6">
            ...
            &emsp;
            <input type="button" class="btn btn-secondary" onclick="window.location.href='../controleur/retour.php'"
              value="Annuler" />
          </div>
        </section>
      </div>
