...
<body>
    ...
    <form method="GET" action="" name="add">
        ...
        <div class="container">
            <form id="formulaire" class="row g-3" method="GET" action="" name="add">
                ...
                <div id="div_demande_motif" class="modal-body" style="display:none;"  >

                        <label for="motif_demande">jouter un autre motif </label>
                        <input type="text" id="motif_demande" name="motif_demande" class="btn" data-toggle="modal" data-target="#exampleModalCenter"></input>
    ...
    <script>
        ...
        elt.addEventListener('change', function() {
            ...
            if (text == "autre") {
                document.getElementById("div_demande_motif").style.display = "inline"
                document.getElementById("motif_demande").focus()
            }else cacherDemandMotif()
        })
function cacherDemandMotif(){
    document.getElementById("div_demande_motif").style.display = "none"
